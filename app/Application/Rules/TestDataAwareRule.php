...
/**
 * TestDataAwareRule Rule
 *
 * Data-aware validation rule - has access to all validation data.
 * Use this for rules that need to compare with other fields (e.g., "same", "different").
 *
 * Performance: ValidationData is passed by reference (no copying)
 */
final class TestDataAwareRule implements DataAwareRuleInterface
{
    /**
     ...
     * You can cache/precompute values from data here.
     *
    ...
    public function passes(string $attribute, mixed $value): bool
    {
        ...
        // Access other fields via $this->data->get('field_name')
        return true;
    }
