...
final class KafkaTopicManagerCommand extends Command
{
    ...
    private ?TopicServiceInterface $topicService = null;
    private ?HealthCheckerInterface $healthChecker = null;
    private ?ClusterFixerInterface $clusterFixer = null;
     ...
     *
     * @return TopicServiceInterface
     */
    private function getTopicService(): TopicServiceInterface
    {
        if ($this->topicService === null) {
            $this->topicService = $this->container->get(TopicServiceInterface::class);
        }
     ...
     */
    private function getHealthChecker(): HealthCheckerInterface
    {
        if ($this->healthChecker === null) {
            $this->healthChecker = $this->container->get(HealthCheckerInterface::class);
        }
        return $this->healthChecker;
    }

    /**
     * Get cluster fixer instance (lazy initialization).
     *
     * @return ClusterFixerInterface
     */
    private function getClusterFixer(): ClusterFixerInterface
    {
        if ($this->clusterFixer === null) {
            $this->clusterFixer = $this->container->get(ClusterFixerInterface::class);
        }
