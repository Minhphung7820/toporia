...
final class EventGenerateCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $eventsPath = $this->getBasePath() . '/src/App/Infrastructure/Providers/EventServiceProvider.php';

        if (!file_exists($eventsPath)) {
            $this->warn('EventServiceProvider not found. Please ensure it exists at:');
            $this->info('src/App/Infrastructure/Providers/EventServiceProvider.php');
            return 1;
        }
    ...
    private function classToPath(string $class): string
    {
        ...
        return $this->getBasePath() . '/src/App/' . $path . '.php';
    }
